...
import { Avatar, Box, Button, ButtonBase, Card, CardContent, CardMedia, Grid, Typography } from '@mui/material'

function Song({songDetails}) {

  return (
          
              <Card sx={{ height:'fit-content', width:175, flexDirection: 'column' , backgroundColor:'#161616'   , '&:hover': {background: "#2c2a35"}, padding:2, borderRadius:2 }}>
                      <CardMedia
                          component="img"
