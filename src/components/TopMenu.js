...
function TopMenu() {
  return (
    <Grid container sx={{ zIndex:100, position:'fixed', backgroundColor:'#181818', paddingBottom:1}}>
        <Grid item xs={1}>
        ...
        <Grid item xs={4}>
            <Grid container sx={{ marginTop:2, display:'flex', justifyContent:'right',justifyItems:'right'}}>
                <Grid item xs={2.5}>
                    <HomeRounded fontSize='medium' sx={{color:'white'}}/>
                </Grid>
                <Grid item xs={2.5}>
                    <UploadRounded fontSize='medium' sx={{color:'white'}}/>
                </Grid>
                <Grid item xs={2.5}>
                    <QueueMusicRounded fontSize='medium' sx={{color:'white'}}/>
                </Grid>
            </Grid>
        </Grid>    
